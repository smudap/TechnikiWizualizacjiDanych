...
PianoMedia.translateConstants['pl'] = {"bar.landingpage.agora.optout":"aHR0cDovL3d5Ym9yY3phLnBsLzAsMTM0NjM4Lmh0bWw\/Y3RhPXBpYW5vLWJhcg==","bar.landingpage.agora.standard":"aHR0cDovL3d5Ym9yY3phLnBsLzAsMTM0OTgxLmh0bWw\/Y3RhPXBpYW5vLWJhcg==","bar.login.agora":"WmFsb2d1aiBzacSZ","bar.loginbox.register":"WmFyZWplc3RydWogc2nEmQ==","bar.close":"WmFta25pag==","bar.account.payment.agora":"V3lrdXAgZG9zdMSZcA==","bar.article_count.agora":"UMOzxYIgcm9rdSB3IGNlbmllIGt3YXJ0YcWCdS4gVHlsa28gdyB0ZW4gd2Vla2VuZCAmZ3Q7Jmd0Ow==","bar.account.inactive.agora":"VHdvamEgcHJlbnVtZXJhdGEgamVzdCA8c3BhbiBjbGFzcz0iaW5hY3RpdmUiPm5pZWFrdHl3bmE8L3NwYW4+","bar.logout.agora":"V3lsb2d1aiBzacSZ","bar.account.active.agora":"VHdvamEgcHJlbnVtZXJhdGEgamVzdCA8c3BhbiBjbGFzcz0iYWN0aXZlIj5ha3R5d25hPC9zcGFuPiBkbw==","bar.dropdown.subscribe":"emFwcmVudW1lcnVq","bar.login":"WkFMT0dVSiBTScSY","bar.logout":"V1lMT0dVSiBTScSY","bar.details":"SlXFuyBPRCA5LDkwIFrFgSAtIEtMSUtOSUogVFVUQUo=","bar.info_text":"UGlhbm8gcG96d2FsYSBuYSBuaWVvZ3Jhbmljem9ueSBkb3N0xJlwIGRvIHRlaiBzdHJvbnku","bar.article_count":"UGlhbm8gb2ZlcnVqZSBkemlzaWFqIGRvc3TEmXAgZG8gPHNwYW4gc3R5bGU9ImJhY2tncm91bmQtY29sb3I6ICM0Mjk4MGM7IGNvbG9yOiAjZmZmOyI+WFhYIG5vd3ljaCBhcnR5a3XFgsOzdy48L3NwYW4+","bar.notice_box.text1":"YmFyLm5vdGljZV9ib3gudGV4dDE=","bar.notice_box.text2-4":"YmFyLm5vdGljZV9ib3gudGV4dDItNA==","bar.notice_box.text5":"YmFyLm5vdGljZV9ib3gudGV4dDU=","bar.notice_box.buy_button":"YmFyLm5vdGljZV9ib3guYnV5X2J1dHRvbg==","bar.notice_box.text1.agora":"","bar.notice_box.text2-4.agora":"","bar.notice_box.text5.agora":""}
...
PianoMedia.template.contentProvider = {         "landingPageByPastSubscription": {             "true": "bar.landingpage.agora.optout",             "false": "bar.landingpage.agora.standard"         }     };

PianoMedia.template.sources = {
    ...
    checkFirstLoad: function(piano_visit_key)
    {
        if (PianoMedia.mode == 'init_cookie')
        {
            ...
            if (typeof stored_key != undefined && stored_key != '' && stored_key != null)
            {
                ...
                if (is_post !== true)
                {
                    PianoMedia.cookieHandler.setSimpleCookie(referer_param, PianoMedia.referer);
                    PianoMedia.cookieHandler.setSimpleCookie("piano_referer_bar", PianoMedia.referer);
                    window.location.reload();
                    return;
                }
            }
            if (!cookie_stored || is_post === true)
            {
                ...
                if (!cookie_stored) {
                    ...
                    insertArg(referer_param, PianoMedia.referer);
                }
