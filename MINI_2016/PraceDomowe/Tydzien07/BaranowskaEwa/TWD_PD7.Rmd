...
Wykres jest dodany jako plik htmlowy do folderu, po pobraniu go na dysk powinien wyświetlać się poprawnie (jeśli wystąpią problemy z kodowaniem, można np. przy użyciu Notepad++ zamienić format kodowania na utf-8).
