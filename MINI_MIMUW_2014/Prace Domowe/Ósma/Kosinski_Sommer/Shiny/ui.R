...
#       
      ...
      selectInput("czcionka", label = "Wybierz czcionk? na wykresie",
      ...
      checkboxInput("legenda", label = "Pokazuj legend?", value = FALSE),
    ...
    mainPanel(
      ...
      plotOutput("betterPlot", width=1200, height=800)
